...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "webpro.js", "musewpslideshow.js", "jquery.museoverlay.js", "touchswipe.js", "jquery.musepolyfill.bgsize.js", "jquery.watch.js", "require.js", "index.css"], "outOfDate":[]};
  ...
  <title>Inicio</title>
  <!-- CSS -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url()."assets/";?>css/site_global.css?crc=443350757"/>
  <link rel="stylesheet" type="text/css" href="<?php echo base_url()."assets/";?>css/index.css?crc=179389031" id="pagesheet"/>
   </head>
 <body>
  ...
  <div class="clearfix borderbox" id="page"><!-- group -->
   ...
   <a class="nonblock nontext MuseLinkActive" id="u155-4" href="<?php echo base_url()."assets/";?>"><!-- rasterized frame --><img id="u155-4_img" alt="INICIO" width="105" height="22" src="<?php echo base_url()."assets/";?>images/u155-4-a.png?crc=331381876"/></a>
   <div class="clearfix grpelem" id="ppu165"><!-- column -->
    <a class="nonblock nontext anim_swing transition pinned-colelem" id="u165" href="#conocenos"><!-- state-based BG images --><img id="u165_states" alt="CONÓCENOS" src="<?php echo base_url()."assets/";?>images/blank.gif?crc=4208392903"/></a>
    <a class="nonblock nontext anim_swing transition pinned-colelem" id="u170" href="#ponentes"><!-- state-based BG images --><img id="u170_states" alt="PONENTES" src="<?php echo base_url()."assets/";?>images/blank.gif?crc=4208392903"/></a>
    <a class="nonblock nontext anim_swing transition pinned-colelem" id="u173" href="#programa"><!-- state-based BG images --><img id="u173_states" alt="PROGRAMA" src="<?php echo base_url()."assets/";?>images/blank.gif?crc=4208392903"/></a>
    <a class="nonblock nontext anim_swing transition pinned-colelem" id="u176" href="#patrocinadores"><!-- state-based BG images --><img id="u176_states" alt="PATROCINADORES" src="<?php echo base_url()."assets/";?>images/blank.gif?crc=4208392903"/></a>
    <a class="nonblock nontext anim_swing transition pinned-colelem" id="u179" href="#regristro"><!-- state-based BG images --><img id="u179_states" alt="REGISTRO" src="<?php echo base_url()."assets/";?>images/blank.gif?crc=4208392903"/></a>
   </div>
   <div class="clearfix grpelem" id="pu927"><!-- column -->
    <a class="nonblock nontext colelem" id="u927" href="https://www.facebook.com/"><!-- simple frame --></a>
    <img class="colelem" id="u495" alt="" src="<?php echo base_url()."assets/";?>images/ponentes-u495.png?crc=3866362099" data-image-width="1206"/><!-- rasterized frame -->
   </div>
   ...
   <div class="shadow clip_frame grpelem" id="u2469"><!-- image -->
    <img class="block" id="u2469_img" src="<?php echo base_url()."assets/";?>images/programa%20(1).jpg?crc=54899802" alt="" data-image-width="1046" data-image-height="1356"/>
   </div>
    ...
    <div class="popup_anchor" id="u1467popup">
     <div class="ContainerGroup clearfix" id="u1467"><!-- none box -->
      ...
      <div class="Container invi shadow clearfix grpelem" id="u1608"><!-- group -->
       <img class="grpelem" id="u2085-9" alt="• Director General de Borghino Consultores que se especializa en el desarrollo de ejecutivos y personal de las empresas. • Conferencista, Investigador, Escritor, Consejero, Asesor, experto en temas de Planeación Estratégica, Liderazgo, y Rescate de negocios. " src="<?php echo base_url()."assets/";?>images/u2085-9.png?crc=4069477664" data-image-width="188"/><!-- rasterized frame -->
      </div>
      ...
      <div class="Container invi shadow clearfix grpelem" id="u1600"><!-- group -->
       <img class="grpelem" id="u2499-16" alt="&nbsp;• Ph.D. in Management from the Kelley School of Business at Indiana University . • Juris Doctor from the Brandeis School of Law at the University of Louisville. • Professor of Management and serves as Associate Dean of the Gordon Ford College of Business and leads the graduate business degrees at Western Kentucky University in Kentucky, USA. • Coauthor of seven books, including HRM: Strategies for Managing a Diverse and Global Workforce and Human Resource Management in South Africa. • Professor Hatfield has consulted with dozens of organizations in the development of leadership, communication, human resources, corporate culture, and collegiality. " src="<?php echo base_url()."assets/";?>images/u2499-16.png?crc=4047001016" data-image-width="429"/><!-- rasterized frame -->
      </div>
   ...
   <div class="clearfix grpelem" id="ppu930"><!-- column -->
       ...
       <div class="Container rounded-corners clearfix grpelem" id="u2331"><!-- group -->
        <form class="form-grp clearfix grpelem" id="widgetu2395" method="post" enctype="multipart/form-data" action="scripts/form-u2395.php"><!-- none box -->
         ...
         <div class="fld-grp clearfix grpelem" id="widgetu2408" data-required="true" data-type="email"><!-- none box -->
          ...
          <span class="fld-input NoWrap actAsDiv clearfix grpelem" id="u2410-4"><!-- content --><input class="wrapped-input" type="email" spellcheck="false" id="widgetu2408_input" name="Email" tabindex="2"/><label class="wrapped-input fld-prompt" id="widgetu2408_prompt" for="widgetu2408_input"><span class="actAsPara">Introducir password</span></label></span>
         </div>
    ...
    <div class="clearfix colelem" id="pu2479"><!-- group -->
     <div class="clip_frame grpelem" id="u2479"><!-- image -->
      <img class="block" id="u2479_img" src="<?php echo base_url()."assets/";?>images/bob%20hatfield.png?crc=4007523445" alt="" data-image-width="209" data-image-height="263"/>
     </div>
     <img class="grpelem" id="u1648-4" alt="Jorge Vergara" src="<?php echo base_url()."assets/";?>images/u1648-4.png?crc=3923260383" data-image-width="145"/><!-- rasterized frame -->
     <img class="grpelem" id="u1656-4" alt="paola longoria" src="<?php echo base_url()."assets/";?>images/u1656-4.png?crc=399510593" data-image-width="145"/><!-- rasterized frame -->
     <img class="grpelem" id="u2079-4" alt="DR. BOB" src="<?php echo base_url()."assets/";?>images/u2079-4.png?crc=13786545" data-image-width="68"/><!-- rasterized frame -->
     <img class="grpelem" id="u1669-4" alt="Mario Borghino " src="<?php echo base_url()."assets/";?>images/u1669-4.png?crc=369133229" data-image-width="183"/><!-- rasterized frame -->
    </div>
    <div class="clearfix colelem" id="pu1747-4"><!-- group -->
     <img class="grpelem" id="u1747-4" alt="Sergio Sepúlveda " src="<?php echo base_url()."assets/";?>images/u1747-4.png?crc=3892462991" data-image-width="183"/><!-- rasterized frame -->
     <img class="grpelem" id="u1675-4" alt="Nicolás Maslo " src="<?php echo base_url()."assets/";?>images/u1675-4.png?crc=4211071727" data-image-width="183"/><!-- rasterized frame -->
     <img class="grpelem" id="u1724-4" alt="Álvaro Rattinger " src="<?php echo base_url()."assets/";?>images/u1724-4.png?crc=4062662830" data-image-width="183"/><!-- rasterized frame -->
    </div>
    <img class="colelem" id="u704-4" alt="Patrocinadores" src="<?php echo base_url()."assets/";?>images/u704-4.png?crc=237065417" data-image-width="324"/><!-- rasterized frame -->
    ...
    <form class="form-grp clearfix colelem" id="widgetu746" method="post" enctype="multipart/form-data" action="scripts/form-u746.php"><!-- none box -->
     <div class="fld-grp clearfix grpelem" id="widgetu748" data-required="true"><!-- none box -->
      ...
      <span class="fld-input NoWrap actAsDiv clearfix grpelem" id="u749-4"><!-- content --><input class="wrapped-input" type="text" spellcheck="false" id="widgetu748_input" name="custom_U748" tabindex="4"/><label class="wrapped-input fld-prompt" id="widgetu748_prompt" for="widgetu748_input"><span class="actAsPara">MATRÍCULA</span></label></span>
     </div>
  ...
  <div class="preload_images">
   ...
   <img class="preload" src="<?php echo base_url()."assets/";?>images/u2446-a.png?crc=456310885" alt=""/>
...
var muse_init=function(){require.config({baseUrl:"<?php echo base_url();?>"});require(["jquery","museutils","whatinput","webpro","musewpslideshow","jquery.museoverlay","touchswipe","jquery.musepolyfill.bgsize","jquery.watch"],function(d){var $ = d;$(document).ready(function(){try{
window.Muse.assets.check($);/* body */
Muse.Utils.transformMarkupToFixBrowserProblemsPreInit();/* body */
Muse.Utils.prepHyperlinks(true);/* body */
Muse.Utils.fullPage('#page');/* 100% height page */
Muse.Utils.initWidget('#pamphletu1458', ['#bp_infinity'], function(elem) { return new WebPro.Widget.ContentSlideShow(elem, {contentLayout_runtime:'loose',event:'mouseover',deactivationEvent:'mouseout_trigger',autoPlay:false,displayInterval:3000,transitionStyle:'fading',transitionDuration:500,hideAllContentsFirst:true,shuffle:false,enableSwipe:true,resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); });/* #pamphletu1458 */
Muse.Utils.initWidget('#widgetu2395', ['#bp_infinity'], function(elem) { return new WebPro.Widget.Form(elem, {validationEvent:'submit',errorStateSensitivity:'high',fieldWrapperClass:'fld-grp',formSubmittedClass:'frm-sub-st',formErrorClass:'frm-subm-err-st',formDeliveredClass:'frm-subm-ok-st',notEmptyClass:'non-empty-st',focusClass:'focus-st',invalidClass:'fld-err-st',requiredClass:'fld-err-st',ajaxSubmit:true}); });/* #widgetu2395 */
Muse.Utils.initWidget('#pamphletu2323', ['#bp_infinity'], function(elem) { return new WebPro.Widget.ContentSlideShow(elem, {contentLayout_runtime:'lightbox',event:'click',deactivationEvent:'none',autoPlay:false,displayInterval:3000,transitionStyle:'fading',transitionDuration:1000,hideAllContentsFirst:false,shuffle:false,enableSwipe:true,resumeAutoplay:true,resumeAutoplayInterval:3000,playOnce:false,autoActivate_runtime:false}); });/* #pamphletu2323 */
Muse.Utils.initWidget('#widgetu746', ['#bp_infinity'], function(elem) { return new WebPro.Widget.Form(elem, {validationEvent:'submit',errorStateSensitivity:'high',fieldWrapperClass:'fld-grp',formSubmittedClass:'frm-sub-st',formErrorClass:'frm-subm-err-st',formDeliveredClass:'frm-subm-ok-st',notEmptyClass:'non-empty-st',focusClass:'focus-st',invalidClass:'fld-err-st',requiredClass:'fld-err-st',ajaxSubmit:true}); });/* #widgetu746 */
Muse.Utils.initWidget('#widgetu2185', ['#bp_infinity'], function(elem) { return new WebPro.Widget.Form(elem, {validationEvent:'submit',errorStateSensitivity:'high',fieldWrapperClass:'fld-grp',formSubmittedClass:'frm-sub-st',formErrorClass:'frm-subm-err-st',formDeliveredClass:'frm-subm-ok-st',notEmptyClass:'non-empty-st',focusClass:'focus-st',invalidClass:'fld-err-st',requiredClass:'fld-err-st',ajaxSubmit:true}); });/* #widgetu2185 */
